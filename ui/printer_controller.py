...
class PrinterController:
    ...
    def print_receipt(self, cart, total_due, payments, change,
                      store_info=None, logo_path=None,
                      homepage_url=None, transaction_id=None):
        """
...
if __name__ == "__main__":
    ...
    pc.print_receipt(cart, total_due, payments, change,
                     store_info, logo_path, homepage_url,
                     transaction_id)
    pc.open_drawer()
